...
public abstract class AbstractBsCmKishTesuryoCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;CmKishTesuryoCB&gt;() {
     ...
     */
    public HpSSQFunction<CmKishTesuryoCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, CmKishTesuryoCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;CmKishTesuryoCB&gt;() {
     *     public void query(CmKishTesuryoCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishTesuryoCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, CmKishTesuryoCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;CmKishTesuryoCB&gt;() {
     *     public void query(CmKishTesuryoCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishTesuryoCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, CmKishTesuryoCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;CmKishTesuryoCB&gt;() {
     *     public void query(CmKishTesuryoCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishTesuryoCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, CmKishTesuryoCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;CmKishTesuryoCB&gt;() {
     *     public void query(CmKishTesuryoCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishTesuryoCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, CmKishTesuryoCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishTesuryoCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, CmKishTesuryoCB.class);
    }
