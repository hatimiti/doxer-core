...
public abstract class AbstractBsCmTesuryoKbCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;CmTesuryoKbCB&gt;() {
     ...
     */
    public HpSSQFunction<CmTesuryoKbCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, CmTesuryoKbCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;CmTesuryoKbCB&gt;() {
     *     public void query(CmTesuryoKbCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmTesuryoKbCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, CmTesuryoKbCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;CmTesuryoKbCB&gt;() {
     *     public void query(CmTesuryoKbCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmTesuryoKbCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, CmTesuryoKbCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;CmTesuryoKbCB&gt;() {
     *     public void query(CmTesuryoKbCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmTesuryoKbCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, CmTesuryoKbCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;CmTesuryoKbCB&gt;() {
     *     public void query(CmTesuryoKbCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmTesuryoKbCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, CmTesuryoKbCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmTesuryoKbCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, CmTesuryoKbCB.class);
    }
