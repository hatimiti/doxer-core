...
public abstract class AbstractBsCmRenrakusakiYotoKbCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;CmRenrakusakiYotoKbCB&gt;() {
     ...
     */
    public HpSSQFunction<CmRenrakusakiYotoKbCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, CmRenrakusakiYotoKbCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;CmRenrakusakiYotoKbCB&gt;() {
     *     public void query(CmRenrakusakiYotoKbCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmRenrakusakiYotoKbCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, CmRenrakusakiYotoKbCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;CmRenrakusakiYotoKbCB&gt;() {
     *     public void query(CmRenrakusakiYotoKbCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmRenrakusakiYotoKbCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, CmRenrakusakiYotoKbCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;CmRenrakusakiYotoKbCB&gt;() {
     *     public void query(CmRenrakusakiYotoKbCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmRenrakusakiYotoKbCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, CmRenrakusakiYotoKbCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;CmRenrakusakiYotoKbCB&gt;() {
     *     public void query(CmRenrakusakiYotoKbCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmRenrakusakiYotoKbCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, CmRenrakusakiYotoKbCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmRenrakusakiYotoKbCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, CmRenrakusakiYotoKbCB.class);
    }
