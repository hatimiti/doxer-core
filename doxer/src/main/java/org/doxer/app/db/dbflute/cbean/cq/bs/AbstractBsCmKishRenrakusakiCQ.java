...
public abstract class AbstractBsCmKishRenrakusakiCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_Equal()</span>.max(new SubQuery&lt;CmKishRenrakusakiCB&gt;() {
     ...
     */
    public HpSSQFunction<CmKishRenrakusakiCB> scalar_Equal() {
        return xcreateSSQFunction(CK_EQ, CmKishRenrakusakiCB.class);
    }
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_NotEqual()</span>.max(new SubQuery&lt;CmKishRenrakusakiCB&gt;() {
     *     public void query(CmKishRenrakusakiCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishRenrakusakiCB> scalar_NotEqual() {
        return xcreateSSQFunction(CK_NES, CmKishRenrakusakiCB.class);
    }
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;CmKishRenrakusakiCB&gt;() {
     *     public void query(CmKishRenrakusakiCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishRenrakusakiCB> scalar_GreaterThan() {
        return xcreateSSQFunction(CK_GT, CmKishRenrakusakiCB.class);
    }
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessThan()</span>.max(new SubQuery&lt;CmKishRenrakusakiCB&gt;() {
     *     public void query(CmKishRenrakusakiCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishRenrakusakiCB> scalar_LessThan() {
        return xcreateSSQFunction(CK_LT, CmKishRenrakusakiCB.class);
    }
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;CmKishRenrakusakiCB&gt;() {
     *     public void query(CmKishRenrakusakiCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishRenrakusakiCB> scalar_GreaterEqual() {
        return xcreateSSQFunction(CK_GE, CmKishRenrakusakiCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<CmKishRenrakusakiCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE, CmKishRenrakusakiCB.class);
    }
