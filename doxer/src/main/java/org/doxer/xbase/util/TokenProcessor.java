...
public class TokenProcessor {
	...
	public static final String TRANSACTION_TOKEN_KEY = "__org.doxer.xbase.util.TokenProcessor#TRANSACTION_TOKEN_KEY__";
	public static final String TOKEN_KEY = "DOX_TOKEN";
